...
//------------UART_Init------------
// Initialize the UART for 57600 baud rate (assuming 50 MHz UART clock),
...
void UART0_Init(void){
  ...
  UART0_IBRD_R = 17;                    // IBRD = int(16,000,000 / (16000000 * 57600)) = int(17.3611)
  UART0_FBRD_R = 23;                    // FBRD = int(0.3611 * 64 + 0.5) = 23.6 ~ 23
                                        // 8 bit word length (no parity bits, one stop bit,  FIFOs enabled)
